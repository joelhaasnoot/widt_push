 ...
 *         &lt;element name="Type" type="{urn:ndov:cdm:trein:reisinformatie:data:2}TypeType"/>
 *         &lt;element name="KorteNaam" type="{urn:ndov:cdm:trein:reisinformatie:data:2}KorteNaamType"/>
 *         &lt;element name="MiddelNaam" type="{urn:ndov:cdm:trein:reisinformatie:data:2}MiddelNaamType"/>
 *         &lt;element name="LangeNaam" type="{urn:ndov:cdm:trein:reisinformatie:data:2}LangeNaamType"/>
 *         &lt;element name="UICCode" type="{urn:ndov:cdm:trein:reisinformatie:data:2}UICCodeType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    EindBestemmingPlannedActueelType.class,
    StationPlannedActueelType.class
})
